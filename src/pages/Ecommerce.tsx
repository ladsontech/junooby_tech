        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-400">Optimized for speed to reduce bounce rates and improve user experience.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">SSL encryption and PCI compliance ensure safe transactions for your customers.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">Built to handle increased traffic and sales as your business grows.</p>
            </div>
          </div>
        </div>
      </section>
