            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-lg font-medium hover:shadow-lg transition-all duration-300 hover:scale-105">
                    Get Quote
                  </button>
                </div>
              </div>
