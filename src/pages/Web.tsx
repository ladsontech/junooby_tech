        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-400">Reach customers worldwide, 24/7, expanding your business beyond geographical boundaries.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Brand Credibility</h3>
              <p className="text-gray-400">Establish trust and professionalism with a modern, well-designed website.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Cost-Effective Marketing</h3>
              <p className="text-gray-400">Your website works as a powerful marketing tool, generating leads and sales continuously.</p>
            </div>
          </div>
        </div>
      </section>
