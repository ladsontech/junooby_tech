...
const ProductsLayout: React.FC<ProductsLayoutProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
      ...
      {/* Products-specific footer - REMOVED "View Our Services" link */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-8 lg:gap-12 xl:gap-16">
            <div className="space-y-4 lg:space-y-6 xl:col-span-2">
              <div className="flex items-center space-x-2 lg:space-x-3">
                ...
                />
                <div 
                  className="w-8 h-8 lg:w-10 lg:h-10 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg" 
                  style={{ display: 'none' }}
                ></div>
              ...
              {/* REMOVED the "View Our Services" button */}
            </div>
