...
const staticProducts: Product[] = [
  {
    ...
    category: 'pcs',
    price: '1500000',
    description: 'Powerful business laptop with Intel Core i5 processor, 8GB RAM, and 256GB SSD.',
    specs: ['Intel Core i5-8250U', '8GB DDR4 RAM', '256GB SSD'],
  ...
  },
  {
    ...
    category: 'phones',
    price: '4500000',
    description: 'Flagship smartphone with S Pen, 200MP camera, and titanium frame.',
    specs: ['Snapdragon 8 Gen 3', '12GB RAM', '200MP Camera'],
    main_image_url: '/images/HP 15_6.jpg',
    featured: true,
  },
  {
    ...
    category: 'cctv',
    price: '350000',
    description: '24/7 color surveillance with built-in microphone and IP67 weatherproof rating.',
    specs: ['4MP Resolution', 'ColorVu Technology', 'IP67 Weatherproof'],
    main_image_url: '/images/HP 15_6.jpg',
    featured: true,
  },
  {
    ...
    category: 'pcs',
    price: '2200000',
    description: 'Premium business laptop with Intel Core i7, FHD display, and long battery life.',
    specs: ['Intel Core i7-1165G7', '16GB DDR4 RAM', '512GB NVMe SSD'],
    main_image_url: '/images/HP 15_6.jpg',
    featured: true,
  },
];
                ...
                >
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute top-3 left-3 flex flex-wrap gap-1">
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${product.category === 'gadgets'
