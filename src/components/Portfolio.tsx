...
const projects: Project[] = [
  ...
  },
  {
    ...
    link: 'https://bacasif.org',
    categories: ['web', 'ngo'],
  },
  {
    name: 'Buyaff',
    description: 'Bunyoro Yaitu Frontier Foundation — community development organization',
    logo: '/images/buyaff_logo.png',
    link: 'https://buyaff.org',
    categories: ['web', 'ngo'],
  },
  {
    name: 'Earigers',
    description: 'Container logistics and cross-border trucking',
    logo: '/images/earigers_logo.png',
    link: 'https://earigers.com',
    categories: ['web'],
  },
  {
    name: 'Tubros Hardware',
    description: 'Construction and hardware supplies company',
    logo: '/images/tubroshardware_logo.png',
    link: 'https://tubroshardware.com',
    categories: ['web'],
  },
  {
    name: 'Hostel Connect',
