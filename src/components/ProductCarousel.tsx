          ...
          <CarouselContent className="-ml-2 md:-ml-4">
            {products.map((product) => (
              <CarouselItem key={product.id} className="pl-2 md:pl-4 basis-full sm:basis-1/2 lg:basis-1/3 xl:basis-1/4 2xl:basis-1/5">
                <div className="bg-gradient-to-br from-white to-blue-50 rounded-xl lg:rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group h-full flex flex-col border border-blue-100">
                  ...
                  <div className="p-4 md:p-5 lg:p-6 flex flex-col flex-grow">
                    ...
                    <div className="space-y-1 mb-3 md:mb-4 flex-grow">
