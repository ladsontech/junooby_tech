...
const WhatsappButton = ({
  ...
  return (
    <button 
      onClick={handleClick} 
      className="flex items-center gap-2 border-2 border-green-500 text-green-400 px-6 md:px-8 py-3 md:py-4 rounded-lg font-semibold text-base md:text-lg hover:bg-green-500 hover:text-black transition-all duration-300 text-center animate-neon-pulse"
    >
...
const Hero = () => {
  ...
  return (
    <section className="min-h-[70vh] bg-background tech-grid pt-16 pb-8 md:pt-24 md:pb-14 flex items-center animate-fade-in relative overflow-hidden">
