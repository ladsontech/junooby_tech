        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="space-y-6 md:space-y-8 animate-fade-in order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link to="/products" className="border-2 border-blue-600 text-blue-600 px-6 md:px-8 py-3 md:py-4 rounded-lg font-semibold text-base md:text-lg hover:bg-blue-600 hover:text-white transition-all duration-300 text-center">
                View Products
              </Link>
            </div>
          </div>
          ...
          <div className="relative animate-scale-in order-1 lg:order-2">
            ...
            }} className="w-full h-64 md:h-80 lg:h-96 rounded-3xl shadow-2xl object-cover" />
