        ...
        <div className="px-4">
          <div className="flex justify-between items-center h-16">
            <Link to="/" className="flex items-center space-x-2">
              ...
              />
              <div className="w-8 h-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg" style={{display: 'none'}}></div>
              <span className="text-xl font-bold text-gray-900">Junooby</span>
            </Link>
          ...
          <div className="absolute top-16 left-0 right-0 bg-white shadow-lg border-t">
            <div className="py-4 space-y-2">
              ...
              <Link 
                to="/contact" 
                onClick={() => setIsMenuOpen(false)}
                className="block mx-4 my-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-lg font-medium text-center"
              >
                Contact Us
              </Link>
            </div>
